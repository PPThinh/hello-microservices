...
type HelloServiceClient interface {
	GetHello(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *helloServiceClient) GetHello(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HelloResponse, error) {
...
type HelloServiceServer interface {
	GetHello(context.Context, *emptypb.Empty) (*HelloResponse, error)
...
func (UnimplementedHelloServiceServer) GetHello(context.Context, *emptypb.Empty) (*HelloResponse, error) {
